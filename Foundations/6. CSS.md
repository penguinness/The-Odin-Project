...
Every webpage with CSS follows **the box model**. For any webpage, adding this line to Styles in Elements reveals the boxes clearly:
...
There are three ways to manipulate the size of these boxes:
